  ...
  return (
    <Layout view={"trip"} loggedIn={true}>
      <section className="w-full inline-block bg-white">
        ...
        <section className="edit-trip-grid-wrapper grid grid-flow-row bg-gray-100">
          <div className="flex flex-col items-center justify-start gap-3 pl-32 py-10">
          ...
          <div className="py-10 px-20">
            <form className="flex flex-col justify-center min-w-full h-full text-justify border-2 rounded-md shadow-lg bs-gray-150 bg-white">
              ...
              <div className="flex-grow px-5 py-1">
                ...
                <div className="input-group py-4">
                  ...
                  <div className="flex flex-row gap-4 ">
                    ...
                    <div className="input-group w-1/3 p-2 border-2 rounded-md flex">
                ...
                <div className="input-group py-4">
                  <div className="border-b border-gray-300 h-3 w-full">
                    <div className="px-2 ml-4 w-fit bg-white">Additional Information</div>
                  </div>
