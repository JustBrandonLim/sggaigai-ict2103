          ...
          <div className="relative overflow-x-auto shadow-md sm:rounded-lg ">
            <table className="w-full text-sm text-left text-gray-500 bg-white ">
              <thead className="text-xs text-gray-700 uppercase">
                <tr>
                  <th scope="col" className="px-6 py-3 text-sm bg-gray-50">
                    ID
                  </th>
                  <th scope="col" className="px-6 py-3 text-sm pr-52 bg-gray-50">
                    Email
                  </th>
                  <th scope="col" className="px-6 py-3 text-sm pr-52 bg-gray-50">
                    First Name
                  </th>
                  <th scope="col" className="px-6 py-3 text-sm pr-36 bg-gray-50">
                    Last Name
                  </th>
                  <th scope="col" className="px-6 py-3 text-sm bg-gray-50">
                    Delete
              ...
              <div className="relative flex flex-col w-full bg-white border-0 rounded-md shadow-lg outline-none focus:outline-none">
                ...
                <div className="flex items-center justify-end px-6 pb-6">
                  ...
                  <button
                    ...
                    type="button"
                    onClick={() => {
                      setShowModal(false), deleteBtn(toDelete);
                    }}
                  >
                    Delete
                  </button>
